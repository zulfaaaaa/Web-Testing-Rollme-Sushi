...
public class UpdateMembershipAllDataPage extends PageObject {
    private By dropdown() {
   ...
   public void onDashboardForUpdate() {
    ...
    @Step
    public void adminEditName(String editName) {
        $(hapusName()).click();
        $(inputName()).type(editName);
    }

    @Step
    public void adminEditEmail(String editEmail) {
        $(hapusEmail()).click();
        $(inputEmail()).type(editEmail);
    }
